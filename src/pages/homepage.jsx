...
import Daun1 from "../../dist/assets/daun1.png"; 
import Daun2 from "../../dist/assets/daun2.png";
  ...
  return (
    <>
      {/* HERO SECTION */}
        ...
        <img
          src={Daun2}
          className="absolute bottom-0 right-0 w-[45%] pointer-events-none select-none"
          alt="decor"
        />
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse md:grid md:grid-cols-2 items-center gap-10 px-4 sm:px-6 lg:px-8 relative z-[2]">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6 text-sm sm:text-base">
              ...
              Setorkan sampahmu, kumpulkan poin, dan tukarkan saldo digital langsung di akunmu.
            </p>

            <button className="bg-[#222] text-white py-3 px-7 rounded-xl font-semibold hover:bg-[#018E48] transition">
              Setor Sekarang!
            </button>
          </div>
      ...
      {/* SECTION PROGRAM — tetap seperti punya kamu */}
      <section id="program" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">

          <div className="text-sm sm:text-base inline-block px-5 py-1 border border-[#018E48] text-[#018E48] rounded-full mb-6">
            Fitur Utama
          </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
                {[
                ["Apa Itu ReTrash?", "Platform digital untuk pengelolaan sampah cerdas."],
                ["Cara Tukar Sampah Jadi Saldo?", "Kumpulkan poin dari setiap setoran."],
                ["Apa Manfaat ReTrash?", "Mengelola sampah jadi lebih mudah dan digital."]
                ].map(([title, desc], i) => (
                <div
                    key={i}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mt-4 mb-8 text-sm sm:text-base">
